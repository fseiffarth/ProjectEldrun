...
| `root_mcp.rs` | Root-console MCP tools (`docs/context/root_console.md`): revocable per-spawn token/grant map, policy-based staging, scoped reads, bounded git sweeps and RPC validation; root-only CLI wiring. |
