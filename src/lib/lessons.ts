  ...
  // ── Agents & models ─────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        anchor: '[data-hint-anchor="settings"]',
        placement: "bottom",
        title: "Pick an agent per tab",
        body: "Use the + menu on the tab bar to open a Claude/Codex/Gemini (or other) agent, or a plain shell. A missing command falls back to a shell, and closed agents respawn.",
      },
    ],
  },
  {
