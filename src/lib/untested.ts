...
export const UNTESTED = {
  ...
  "desktop.intro.wizard": { area: "shell", what: "How to start wizard · step rail, Back/Skip/Next, ←/→, remembered page" },
  ...
  "mail.agentDrafts": { area: "mail", what: "MailPane · Drafted by agents rail entry + list" },
  ...
  "mail.accountMenu": { area: "mail", what: "MailOverlay · title-bar accounts dropdown (switch, ✎ edit, Add account)" },
  ...
  "mail.agentAttachmentChip": { area: "mail", what: "MailComposeDialog · a file an agent attached by project and path (source chip, Preview, Send bound to the shown set)" },
  "mail.agentSuggestedRecipient": { area: "mail", what: "MailComposeDialog · Agent suggests: X — Add" },
