...
export function ConnTypeIcon({ type, online, ssid }: Props) {
  ...
  const slash = !online && (
    <>
      <line x1="2.5" y1="2.5" x2="13.5" y2="13.5" stroke="var(--bg)" strokeWidth="2.3" strokeLinecap="round" />
  ...
  if (type === "wlan") {
    return (
      ...
      >
        <title>{label}</title>
        {/* outer arc */}
        <path d="M1.5 6.5 C3.5 4 6.5 2.5 8 2.5 C9.5 2.5 12.5 4 14.5 6.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" fill="none"/>
        {/* middle arc */}
        <path d="M3.5 8.5 C5 7 6.5 6 8 6 C9.5 6 11 7 12.5 8.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" fill="none"/>
        {/* inner arc */}
        <path d="M5.5 10.5 C6.5 9.5 7.2 9 8 9 C8.8 9 9.5 9.5 10.5 10.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" fill="none"/>
        {/* dot */}
  ...
  return (
    ...
    >
      ...
      {/* plug housing */}
      <rect x="3.5" y="5.2" width="9" height="6" rx="1" stroke="currentColor" strokeWidth="1.1" fill="none"/>
